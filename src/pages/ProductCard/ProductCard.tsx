...
<img src="src/images/Siena.png" alt="Siena-Logo" className={style.sienaLogo}/>
<div>
  <h1 className={style.productTitle}>Circle Running Jersey</h1>
    ...
    <div className={style.cardWrapper}>
      ...
      <div className={style.productPicture}>
        <img
          src="https://circlesportswear.com/cdn/shop/files/T-shirt_manches_longues_Feel_Good_Onyx_Black_women_6.jpg?v=1772027696&width=2200"
          alt="Long-sleeve"
        />
      </div>
      ...
      <div className={style.contentSection}>
        <div className={style.descriptionSection}>
          ...
          <div className={style.infoRow}>
            <span className={style.label}>Material:</span> <span>100% Cotton</span>
          </div>
        </div>
